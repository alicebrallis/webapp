...
/* harmony import */ var _models_products__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/products */ "./js/models/products.js");
...
let deliveries = {
    ...
    getDeliveries: async () => {
        ...
        console.log("getDeliveries -> result = ", result);

        deliveries.currentDeliveries = result.data;

        console.log("getDeliveries -> deliveries.currentDeliveries = ", deliveries.currentDeliveries);
    },
    save: () => {

        // console logs
        console.log("save -> product_id = ", deliveries.currentDelivery.product_id);
        console.log("save -> amount = ", deliveries.currentDelivery.amount);
        console.log("save -> delivery_date = ", deliveries.currentDelivery.date);
        console.log("save -> api_key = ", _vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey);
        console.log("save -> comment = ", deliveries.currentDelivery.comment);
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "./node_modules/mithril/index.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _models_deliveries__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/deliveries */ "./js/models/deliveries.js");
/* harmony import */ var _models_products__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/products */ "./js/models/products.js");
...
let form = {
    oninit: _models_products__WEBPACK_IMPORTED_MODULE_2__.default.getProducts,
    view: function() {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()("main.container", [
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("form", {
                onsubmit: function(event) {
                    ...
                    _models_deliveries__WEBPACK_IMPORTED_MODULE_1__.default.save();
                }
            }, [
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("select.input",  {
                    onchange: function(e) {
                        ...
                        _models_deliveries__WEBPACK_IMPORTED_MODULE_1__.default.currentDelivery.product_id = e.target.value;
                        console.log(_models_deliveries__WEBPACK_IMPORTED_MODULE_1__.default.currentDelivery.product_id);
                    },
                }, _models_products__WEBPACK_IMPORTED_MODULE_2__.default.currentProducts.map(function (prod) {
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=number].input",
                 {
                    oninput: function(event) {
                        ...
                        _models_deliveries__WEBPACK_IMPORTED_MODULE_1__.default.currentDelivery.amount = event.target.value;
                    }
                }),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("br", ""),
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=date].input", {
                    oninput: function(event) {
                        console.log(event.target.value);
                        _models_deliveries__WEBPACK_IMPORTED_MODULE_1__.default.currentDelivery.date = event.target.value;
                    }
                }),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("br", ""),
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("textarea[placeholder=Skriv en kommentar].input", {
                    oninput: function(event) {
                        console.log(event.target.value);
                        _models_deliveries__WEBPACK_IMPORTED_MODULE_1__.default.currentDelivery.comment = event.target.value;
                    }
                }),
...
let list = {
    ...
    view: function() {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()("main.container", [
        mithril__WEBPACK_IMPORTED_MODULE_0___default()("h1", "Inleveranser"),
        ...
        mithril__WEBPACK_IMPORTED_MODULE_0___default()("div.deliveries", _models_deliveries_js__WEBPACK_IMPORTED_MODULE_1__.default.currentDeliveries.map(function(delivery){
            ...
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()("div", [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", "Produkt-id: " +  delivery.product_id  + " " + "Antal:" + " " + delivery.amount + "st" 
                + " " + "Datum: " + " " + delivery.delivery_date + " " + "Kommentar:" + " " + delivery.comment),
                console.log("hej this is a new delivery = ", delivery),
            ]);
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "./node_modules/mithril/index.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _views_list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/list.js */ "./js/views/list.js");
/* harmony import */ var _views_form_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/form.js */ "./js/views/form.js");
