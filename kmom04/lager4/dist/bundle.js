...
let deliveries = {
    ...
    getDeliveries: async () => {
        ...
        console.log("getDeliveries -> apiKey = ", _vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey);

        const result = await mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
            method: "GET",
            url: `${deliveries.url}?api_key=${_vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey}`
        });
...
function updateStock() {
    mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
        method: "GET",
        url: `${_vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl}/products/${deliveries.currentDelivery.product_id}?api_key=${_vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey}`
    }).then (function(result) {
...
function newStock(prod) {
    ...
    mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
        method: "PUT",
        url: `${_vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl}/products/:product_id`,
        body: updatedProd
    });
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (deliveries);
...
let invoicesModel = {
    ...
    getInvoices: function() {
        mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
            ...
            method: "GET",
            headers: {
                'x-access-token': _auth_js__WEBPACK_IMPORTED_MODULE_2__["default"].token
            }
        }).then(function(result) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (invoicesModel);
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _vars_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../vars.js */ "./js/vars.js");
/* harmony import */ var _models_invoices__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/invoices */ "./js/models/invoices.js");
...
let orders = {
    ...
    getOrders: function () {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
            method: "GET",
            url: `${_vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl}/orders?api_key=${_vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey}`
        }).then(function (result) {
    ...
    updateOrder: function () {
        ...
        return mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
            method: "GET",
            url: `${_vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl}/orders/${orders.currentOrder}?api_key=${_vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey}`
        }).then(function (result) {
            _models_invoices__WEBPACK_IMPORTED_MODULE_2__["default"].getInvoices(result.data);
            orders.newStockOrder(result.data);
        });
    },
    newStockOrder: function (ord) {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
            url: `${_vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl}/orders`,
            method: "PUT",
            body: {
                id: ord.id,
                name: ord.name,
...
let products = {
    ...
    getProducts: function() {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default().request({
            method: "GET",
            url: `${products.url}?api_key=${_vars_js__WEBPACK_IMPORTED_MODULE_1__.apiKey}`
        }).then(function(result) {
            console.log(result);
...
let reg = {
    url: `${_vars_js__WEBPACK_IMPORTED_MODULE_1__.baseUrl}/auth/register`,
    email: "",
    password: "",
...
"eyJhcGlfa2V5IjoiODUzZDI2M2ZmOGRjM2VhZmZjMTA5MTQxOWU3MTExZmMiLCJ" +
"pYXQiOjE2NjMwNTMzMjIsImV4cCI6MTY2MzEzOTcyMn0.Dz9Em_oT7we_qM7wgZdBYnjx845VowxZQMrGNBrVrVU";
...
let form = {
    oninit: _models_products_js__WEBPACK_IMPORTED_MODULE_2__["default"].getProducts,
    view: function() {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()("main.container", [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("h1", "Ny inleverans"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("form", {
                onsubmit: function(event) {
                    event.preventDefault();
                    _models_deliveries_js__WEBPACK_IMPORTED_MODULE_1__["default"].save();
                }
            }, [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("br", ""),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("label.input-label", "Välj produkt"),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("select.input",  {
                    onchange: function(e) {
                        console.log(e.target.value);
                        _models_deliveries_js__WEBPACK_IMPORTED_MODULE_1__["default"].currentDelivery.product_id = e.target.value;
                        console.log(_models_deliveries_js__WEBPACK_IMPORTED_MODULE_1__["default"].currentDelivery.product_id);
                    },
                }, _models_products_js__WEBPACK_IMPORTED_MODULE_2__["default"].currentProducts.map(function (prod) {
                    return mithril__WEBPACK_IMPORTED_MODULE_0___default()("option", { value: prod.id }, prod.name);
                }
                )),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("br", ""),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("label", "Ange antal"),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=number].input",
                    {
                        oninput: function(event) {
                            console.log(event.target.value);
                            _models_deliveries_js__WEBPACK_IMPORTED_MODULE_1__["default"].currentDelivery.amount = event.target.value;
                        }
                    }),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("br", ""),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("label", "Ange leverans datum"),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=date].input", {
                    oninput: function(event) {
                        console.log(event.target.value);
                        _models_deliveries_js__WEBPACK_IMPORTED_MODULE_1__["default"].currentDelivery.date = event.target.value;
                    }
                }),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("br", ""),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("label", "Skriv en kommentar"),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("textarea[placeholder=Skriv en kommentar].input", {
                    oninput: function(event) {
                        console.log(event.target.value);
                        _models_deliveries_js__WEBPACK_IMPORTED_MODULE_1__["default"].currentDelivery.comment = event.target.value;
                    }
                }),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=submit][value=Spara].button", "Spara"),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("br", ""),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("a", {href: "#!/"}, "Gå tillbaka")
            ])
        ]);
    }
};
...
let invoiceTable = {
    view: function() {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()("table.table.table-stacked.table-striped", [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("thead", [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("tr", [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("th", "Namn"),
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("tbody", _models_invoices_js__WEBPACK_IMPORTED_MODULE_1__["default"].invoices.map(function(invoice) {
...
let noData = {
    view: function() {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", "Det finns inga fakturor");
    }
};
let invoices = {
    oninit: _models_invoices_js__WEBPACK_IMPORTED_MODULE_1__["default"].getInvoices,
    view: function() {
        return [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("h2", "Fakturor"),
            _models_invoices_js__WEBPACK_IMPORTED_MODULE_1__["default"].invoices.length > 0 ? mithril__WEBPACK_IMPORTED_MODULE_0___default()(invoiceTable) : mithril__WEBPACK_IMPORTED_MODULE_0___default()(noData)
        ];
    }
};
...
let list = {
    oninit: _models_deliveries_js__WEBPACK_IMPORTED_MODULE_1__["default"].getDeliveries,
    view: function() {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()("main.container", [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("h2", "Inleveranser"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", "Inga leveranser att visa"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("a", {href: "#!/new"}, "Lägg till leverans"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("br", ""),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("a", {href: "#!/"}, "Gå tillbaka"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("div.deliveries", _models_deliveries_js__WEBPACK_IMPORTED_MODULE_1__["default"].currentDeliveries.map(function(delivery) {
                return mithril__WEBPACK_IMPORTED_MODULE_0___default()("div", [
                    mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", "Produkt-id: " +  delivery.product_id  + " "
    ...
    view: function() {
        return [
            ...
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("form", {
                onsubmit: function(event) {
                    event.preventDefault();
                    _models_auth_js__WEBPACK_IMPORTED_MODULE_1__["default"].login();
                }
            }, [
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=email].input", {
                    oninput: function (event) {
                        console.log(event.target.value);
                        _models_auth_js__WEBPACK_IMPORTED_MODULE_1__["default"].email = event.target.value;
                    },
                    value: _models_auth_js__WEBPACK_IMPORTED_MODULE_1__["default"].email
                }),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("br", ""),
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=password].input", {
                    oninput: function (event) {
                        console.log(event.target.value);
                        _models_auth_js__WEBPACK_IMPORTED_MODULE_1__["default"].password = event.target.value;
                    },
                    value: _models_auth_js__WEBPACK_IMPORTED_MODULE_1__["default"].password
                }),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=submit][value=Logga in],button", "Logga in"),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("a", {href: "#!/"}, "Gå tillbaka")
            ])];
    }};
...
let menu = {
    view: function() {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()("nav", [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()((mithril__WEBPACK_IMPORTED_MODULE_0___default().route.Link), {href: "/"}, "Home"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()((mithril__WEBPACK_IMPORTED_MODULE_0___default().route.Link), {href: "/list"}, "Lager"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()((mithril__WEBPACK_IMPORTED_MODULE_0___default().route.Link), {href: "/login"}, "Logga in"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()((mithril__WEBPACK_IMPORTED_MODULE_0___default().route.Link), {href: "/register"}, "Registera dig"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()((mithril__WEBPACK_IMPORTED_MODULE_0___default().route.Link), {href: "/invoices"}, "Alla fakturor"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()((mithril__WEBPACK_IMPORTED_MODULE_0___default().route.Link), {href: "/order"}, "Fakturera en order")
        ]);
    }
};
...
let order = {
    oninit: _models_orders_js__WEBPACK_IMPORTED_MODULE_1__["default"].getOrders,
    view: function() {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()("main.container", [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("h1", "Välj order för att skapa faktura"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("p", [
                (order.success) ? mithril__WEBPACK_IMPORTED_MODULE_0___default()('.success', order.success) : '',
            ]),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("form", {
                onsubmit: function(event) {
                    event.preventDefault();
                    _models_orders_js__WEBPACK_IMPORTED_MODULE_1__["default"].updateOrder();
                ...
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("select.input",  {
                    onchange: function(e) {
                        _models_orders_js__WEBPACK_IMPORTED_MODULE_1__["default"].currentOrder = e.target.value;
                    }
                }, _models_orders_js__WEBPACK_IMPORTED_MODULE_1__["default"].currentOrders.map(function (ord) {
                    return [
                        ord.status_id == 100 ? mithril__WEBPACK_IMPORTED_MODULE_0___default()("option", { value: ord.id },
                            ord.name) :
                            "",
                    ];
                })),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=submit][value=Skapa faktura].button", "Spara"),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("br", ""),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("a", {href: "#!/"}, "Gå tillbaka")
            ])
        ]);
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "./node_modules/mithril/index.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _models_reg_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/reg.js */ "./js/models/reg.js");
...
let register = {
    view: function() {
        return [
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("h2", "Registrera dig"),
            mithril__WEBPACK_IMPORTED_MODULE_0___default()("form", {
                onsubmit: function(event) {
                    event.preventDefault();
                    _models_reg_js__WEBPACK_IMPORTED_MODULE_1__["default"].regg();
                }
            }, [
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("label.input-label", "E-post"),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=email].input", {
                    oninput: function (event) {
                        console.log(event.target.value);
                        _models_reg_js__WEBPACK_IMPORTED_MODULE_1__["default"].email = event.target.value;
                    },
                    value: _models_reg_js__WEBPACK_IMPORTED_MODULE_1__["default"].email
                }),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("br", ""),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("label.input-label", "Lösenord"),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=password].input", {
                    oninput: function (event) {
                        console.log(event.target.value);
                        _models_reg_js__WEBPACK_IMPORTED_MODULE_1__["default"].password = event.target.value;
                    },
                    value: _models_reg_js__WEBPACK_IMPORTED_MODULE_1__["default"].password
                }),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("input[type=submit][value=Registera],button", "Registrera"),
                mithril__WEBPACK_IMPORTED_MODULE_0___default()("a", {href: "#!/"}, "Gå tillbaka")
            ])];
    }};
...
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mithril */ "./node_modules/mithril/index.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mithril__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _views_menu_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/menu.js */ "./js/views/menu.js");
/* harmony import */ var _views_list_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/list.js */ "./js/views/list.js");
/* harmony import */ var _views_form_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/form.js */ "./js/views/form.js");
/* harmony import */ var _views_invoices_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/invoices.js */ "./js/views/invoices.js");
/* harmony import */ var _views_login_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/login.js */ "./js/views/login.js");
/* harmony import */ var _views_register_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/register.js */ "./js/views/register.js");
/* harmony import */ var _models_auth_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./models/auth.js */ "./js/models/auth.js");
/* harmony import */ var _views_order_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./views/order.js */ "./js/views/order.js");
...
mithril__WEBPACK_IMPORTED_MODULE_0___default().route(document.body, "/", {
    "/": {
        render: function() {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_menu_js__WEBPACK_IMPORTED_MODULE_1__.menu);
        }
    },
    "/list": {
        render: function() {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_list_js__WEBPACK_IMPORTED_MODULE_2__["default"]);
        }
    },
    "/new": {
        render: function () {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_form_js__WEBPACK_IMPORTED_MODULE_3__["default"]);
        }
    },
    "/invoices": {
        onmatch: function() {
            if (_models_auth_js__WEBPACK_IMPORTED_MODULE_7__["default"].token) {
                return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_invoices_js__WEBPACK_IMPORTED_MODULE_4__["default"]);
            }
            return mithril__WEBPACK_IMPORTED_MODULE_0___default().route.set("/login");
        },
        render: function (vnode) {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_invoices_js__WEBPACK_IMPORTED_MODULE_4__["default"], vnode);
        }
    },
    "/login": {
        render: function() {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_login_js__WEBPACK_IMPORTED_MODULE_5__["default"]);
        }
    },
    "/register": {
        render: function() {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_register_js__WEBPACK_IMPORTED_MODULE_6__["default"]);
        }
    },
    "/order": {
        render: function() {
            return mithril__WEBPACK_IMPORTED_MODULE_0___default()(_views_order_js__WEBPACK_IMPORTED_MODULE_8__["default"]);
        }
    }
});
